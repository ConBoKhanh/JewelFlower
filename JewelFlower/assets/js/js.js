...
const productList = [
  {
    ...
    Saleprice: "650.000",
    imgs: [
      "./assets/images/items/15.png",
      "./assets/images/items/01.png",
      "./assets/images/items/02.png",
    ],
    sale: true,
    trending: true,
    top: false,
  ...
  },
  {
    ...
    imgs: [
      ...
      "./assets/images/items/03.png",
      "./assets/images/items/04.png",
    ],
    sale: true,
    trending: true,
    top: false,
  ...
  },
  {
    ...
    imgs: [
      ...
      "./assets/images/items/07.png",
      "./assets/images/items/08.png",
    ],
    sale: true,
    trending: true,
    top: false,
  ...
  },
  {
    ...
    imgs: [
      ...
      "./assets/images/items/09.png",
      "./assets/images/items/010.png",
    ],
    sale: false,
    trending: true,
    top: true,
  ...
  },
  {
    ...
    Saleprice: "680.000",
    imgs: [
      "./assets/images/items/5.png",
      "./assets/images/items/011.png",
      "./assets/images/items/012.png",
    ],
    sale: true,
    trending: true,
    top: true,
  ...
  },
  {
    ...
    Saleprice: "780.000",
    imgs: [
      "./assets/images/items/6.png",
      "./assets/images/items/013.png",
      "./assets/images/items/014.png",
    ],
    sale: false,
    trending: true,
    top: true,
  ...
  },
  {
    ...
    Saleprice: "1.050.000",
    imgs: [
      "./assets/images/items/7.png",
      "./assets/images/items/015.png",
      "./assets/images/items/016.png",
    ],
    sale: true,
    trending: true,
    top: true,
  ...
  },
  {
    ...
    Saleprice: "590.000",
    imgs: [
      "./assets/images/items/8.png",
      "./assets/images/items/017.png",
      "./assets/images/items/018.png",
    ],
    sale: false,
    trending: true,
    top: true,
  ...
  },
  {
    ...
    imgs: [
      ...
      "./assets/images/items/019.png",
      "./assets/images/items/020.png",
    ],
    sale: true,
    trending: true,
    top: true,
  ...
  },
  {
    ...
    Saleprice: "890.000",
    imgs: [
      "./assets/images/items/10.png",
      "./assets/images/items/021.png",
      "./assets/images/items/022.png",
    ],
    sale: false,
    trending: true,
    top: true,
  ...
  },
  {
    ...
    Saleprice: "1.190.000",
    imgs: [
      "./assets/images/items/11.png",
      "./assets/images/items/023.png",
      "./assets/images/items/024.png",
    ],
    sale: true,
    trending: true,
    top: false,
  ...
  },
  {
    ...
    Saleprice: "1.100.000",
    imgs: [
      "./assets/images/items/12.png",
      "./assets/images/items/025.png",
      "./assets/images/items/026.png",
    ],
    sale: false,
    trending: true,
    top: true,
  ...
  },
  {
    ...
    Saleprice: "1.150.000",
    imgs: [
      "./assets/images/items/13.png",
      "./assets/images/items/027.png",
      "./assets/images/items/028.png",
    ],
    sale: true,
    trending: true,
    top: true,
  ...
  },
  {
    ...
    Saleprice: "900.000",
    imgs: [
      "./assets/images/items/14.png",
      "./assets/images/items/029.png",
      "./assets/images/items/030.png",
    ],
    sale: true,
    trending: true,
    top: false,
  ...
  },
  {
    ...
    Saleprice: "700.000",
    imgs: [
      "./assets/images/items/Ảnh31.png",
      "./assets/images/items/Ảnh32.png",
      "./assets/images/items/Ảnh33.png",
    ],
    sale: true,
    trending: true,
    top: false,
  ...
  },
  {
    ...
    Saleprice: "390.000",
    imgs: [
      "./assets/images/items/Ảnh34.png",
      "./assets/images/items/Ảnh35.png",
      "./assets/images/items/Ảnh36.png",
    ],
    sale: true,
    trending: true,
    top: false,
  ...
  },
  {
    ...
    Saleprice: "600.000",
    imgs: [
      "./assets/images/items/Ảnh37.png",
      "./assets/images/items/Ảnh38.png",
      "./assets/images/items/Ảnh39.png",
    ],
    sale: true,
    trending: true,
    top: false,
  ...
  },
  {
    ...
    Saleprice: "590.000",
    imgs: [
      "./assets/images/items/Ảnh40.png",
      "./assets/images/items/Ảnh41.png",
      "./assets/images/items/Ảnh42.png",
    ],
    sale: true,
    trending: true,
    top: false,
  ...
  },
  {
    ...
    Saleprice: "300.000",
    imgs: [
      "./assets/images/items/Ảnh43.png",
      "./assets/images/items/Ảnh44.png",
      "./assets/images/items/Ảnh45.png",
    ],
    sale: true,
    trending: true,
    top: false,
  ...
  },
  {
    ...
    Saleprice: "400.000",
    imgs: [
      "./assets/images/items/Ảnh46.png",
      "./assets/images/items/Ảnh47.png",
      "./assets/images/items/Ảnh48.png",
    ],
    sale: true,
    trending: true,
    top: false,
...
function updateCartCount() {
  ...
  document.querySelector(".count-cart").textContent = totalCount;
}
...
// Gọi hàm khi trang load để cập nhật số lượng giỏ hàng
updateCartCount();


  const allContent = document.querySelector(".all-content");
  allContent.classList.add("display-none");
  const loading = document.querySelector(".loading");

  if (loading) {
    // Khi loading xuất hiện, chặn cuộn

    setTimeout(() => {
      loading.classList.add("hidden"); // Thêm class để chạy transition
      allContent.classList.remove("display-none"); // Cho phép cuộn lại
    }, 300);
  }
  ...
  if (urlParams.has("items")) {
    ...
    if (filteredProduct) {
      ...
      const randomQuote =
        itemRandum[Math.floor(Math.random() * itemRandum.length)];
    ...
    function renderRandomProducts() {
      const container = document.querySelector(".sp-tt");
      container.innerHTML = ""; // Xóa sản phẩm cũ

      let randomProducts = getRandomProducts(productList, 6);
...
<div class="showcase">
  ...
  <div class="showcase-content">
    ...
    <div class="price-box">
      <p class="price" style="color: var(--salmon-pink);">${product.Saleprice}VND</p>
...
`;
    ...
    function showAllIMG() {
      const container = document.querySelector(".show-all-img");
      container.innerHTML = ""; // Xóa ảnh cũ
      const filteredProduct = productList.find((product) => product.id === itemId);
    
      if (filteredProduct) {
        filteredProduct.imgs.forEach((img, index) => {
          let productHTML = `
            <div class="flex-fill text-center border p-1 img-item swiper-slide" 
                 style="max-width:33%; height:150px; border-radius:10px; cursor:pointer" 
                 data-index="${index}">
              <img src="${img}" alt="" 
    ...
    const detailImg = new Swiper(".detail-img", {
      loop: true,
      autoplay: {
        delay: 15000, // Tự động chạy sau 5 giây
        disableOnInteraction: false, // Không dừng khi tương tác
      },
      spaceBetween: 10,
      navigation: {
    ...
    showAllIMG();
    document.querySelector(".show-all-img").addEventListener("click", function (event) {
      const clickedItem = event.target.closest(".img-item"); // Tìm phần tử cha có class "img-item"
      
      if (clickedItem) {
        const index = clickedItem.dataset.index; // Lấy giá trị data-index
        detailImg.slideToLoop(index)
      }
    });
    //
  } else {
...
`;
    ...
    function appendProducts(products, containerSelector) {
      ...
      products.forEach((product) => {
        ...
        const productHTML = `
  <div class="showcase">
    <div class="showcase-banner" style="display:flex">
      <img src="${product.imgs[0]}" alt="${
          product.name
...
<div class="showcase">
  ...
  <div class="showcase-content">
    <a href="/JewelFlower/index.html?items=${product.id}">
      <h4 class="showcase-title" style="">${product.name}</h4>
    </a>
...
`;
  ...
  // Kiểm tra xem modal đã hiển thị hôm nay chưa
  const lastShownDate = localStorage.getItem("modalShownDate");

  if (lastShownDate === today) {
    // Nếu đã hiển thị hôm nay, thêm class "closed" ngay lập tức
    modal.classList.add("closed");
  } else {
    // Nếu chưa hiển thị, lưu ngày và hiển thị modal
...
document.querySelectorAll(".add-to-cart").forEach(button => {
  button.addEventListener("click", function () {
    ...
    if (!product) return; // Nếu không tìm thấy sản phẩm, thoát luôn

    const sizeSelect = document.querySelector(".size-detail"); // Lấy dropdown size
    const quantityInput = document.querySelector(".quantity-detail"); // Lấy input số lượng

    const selectedSize = sizeSelect.value; // Lấy giá trị size hiện tại
    const quantity = parseInt(quantityInput.value, 10); // Lấy số lượng (chuyển thành số)

    if (!selectedSize || isNaN(quantity) || quantity <= 0) return; // Kiểm tra dữ liệu hợp lệ

    let cart = JSON.parse(localStorage.getItem("cart")) || [];

    // Tìm sản phẩm trùng ID & Size trong giỏ hàng
    let existingProduct = cart.find(item => item.id === product.id && item.size === selectedSize);

    if (existingProduct) {
      // Nếu sản phẩm đã tồn tại với cùng size, tăng số lượng
      existingProduct.quantity += quantity;
    } else {
      // Nếu chưa có, thêm mới với size và số lượng
      cart.push({ ...product, size: selectedSize, quantity: quantity });
    }
    const toast = document.querySelector(".notification-toast-message");
    toast.classList.remove("active");
    toast.querySelector(".toast-banner img").src = product.imgs[0];
    toast.querySelector(".toast-banner img").alt = product.name;
    toast.querySelector(".toast-title").textContent = product.name+' ('+selectedSize+')';
    let toastTimeout;
    clearTimeout(toastTimeout);
    toast.classList.add("active"); // Thêm class để hiển thị
